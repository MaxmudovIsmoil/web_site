...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('adminjs/app.js') }}" defer></script>
    ...
    <!-- <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/assets/css/bootstrap.min.css') }}" /> -->

    <link href="{{ asset('admin/assets/plugins/fontawesome/css/fontawesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('admin/assets/plugins/fontawesome/css/all.min.css') }}" rel="stylesheet">

    <link href="{{ asset('admin/assets/plugins/simple-calendar/simple-calendar.css') }}" rel="stylesheet">
