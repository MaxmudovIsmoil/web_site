                    ...
                    <table class="datatable table table-stripped">
                       ...
                       <tbody>
                           ...
                           <tr>
                            ...
                            <td> <img src="{{asset('img/'.$contact->image)}}" width="30px" height="30px"></td>
                           
                            <td class="text-right">
                               <a href="{{ route('contact.edit',$contact->id) }}" class="btn btn-sm btn-white text-success mr-2"><i class="fas fa-edit mr-1"></i></a>
